...
#    Updated: 2018/09/03 19:36:20 by drdraugr         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = libft.a
SRC = ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c ft_isascii.c ft_isdigit.c \
ft_isprint.c ft_itoa.c ft_ltoa.c ft_ultoa.c ft_lstadd.c ft_lstappend.c ft_lstdel.c ft_lstdelone.c \
...
ft_strtrim.c ft_tolower.c ft_toupper.c ft_itoa_base.c ft_ltoa_base.c ft_ultoa_base.c
OBJ=$(SRC:.c=.o)
INC=./includes
